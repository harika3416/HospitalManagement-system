...
<div class="form_wrapper">
  <div class="form_container">
    <div class="title_container">
      <h2>Book appoinment Form</h2>
    </div>
    <div class="row clearfix">
      <div class="">
        <form action="bookappcontroller" method="post">
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
            <input type="email" name="email" placeholder="Email" required />
             ...
             <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
            <input type="email" name="demail" placeholder=" doctor" required />
          </div>
            <div class="input_field"> 
                
                              DoctorName: <select name="doctor" placeholder="select doctor">
                   
                   <option disabled="disabled">select doctor</option>
                     <option>Harika</option>
                     <option>bethu</option>
            ...
            <div class="input_field"> 
            TimeSlot :<select name="time">
                <option>choose your time Slot</option>
                <option>Time :10:00AM to 11:00AM</option>
                                <option>Time :11:00am to 1:00pm</option>
                                <option>Time :2:00pm to  3:00pm</option>
                                <option>Time :4:00pm to  06:00pm</option>
                                <option>Time :06:00pm to 08:00pm</option>
          ...
          <input class="button" type="submit" value="Book appoinment" />
       </form>
   ...
   <table border="2">
     ...
     <th>specialization</th>
                ...
                <%
           		...
           		PreparedStatement pst=	conn.prepareStatement("select *from docter");
